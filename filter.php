    ...
    "columnDefs": [
            {
                ...
                "render": function ( data, type, row ) {
                    return '<a href="form.php?id='+row[0]+'" target="_blank"><b>1)LEASE LETTER</b></a><br><a href="return_letter.php?id='+row[0]+'" target="_blank"><b>2)RETURN LETTER</b></a><br><a href="envelope.php?id='+row[0]+'" target="_blank"><b>3)ENVELOPE COVER</b></a>';
            ...
            },
            {
                ...
                // this case `data: 0`.
                "render": function ( data, type, row ) {
                    return '<a href="editnew.php?id='+row[0]+'"><b>EDIT</b></a>';
                   // return '<a href="form.php?id='+row[0]+'">FORM</a>';
                },
               // "orderable": false,
                "targets":<?php echo $n+1; ?>
            },
            {
                "orderable":false,
                "targets":[-1, -2,-3]
